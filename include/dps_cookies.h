...
extern int DpsCookiesAdd (DPS_AGENT *Indexer, const char *domain, const char *path, const char *name, const char *value, const char secure, dps_uint4 expires, const char from_config, int insert_flag);
extern int DpsCookiesAddStr (DPS_AGENT *Indexer, DPS_URL *CurURL, char *cookie_str, int insert_flag);
