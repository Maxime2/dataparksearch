...
fail !0 exec $(INDEXER) -S $(DPS_TEST_DIR)/indexer.conf >> $(DPS_TEST_LOG) 2>&1
fail !0 exec $(INDEXER) -qam $(DPS_TEST_DIR)/indexer.conf >> $(DPS_TEST_LOG) 2>&1
...
fail !0 exec $(SEARCH) "body+OR+%22six+seven%22&m=bool" > $(DPS_TEST_DIR)/search2.rej 2>&1
fail !0 exec $(SEARCH) "@twitter #trend l'orex <3" > $(DPS_TEST_DIR)/search3.rej 2>&1
