...
<TITLE>DataparkSearch: abcdefghijklmnopqrstuvwxyz</TITLE>
</HEAD>
...
<table bgcolor=#EEEEEE width=100%>
  <tr>
    <td>
      <BR> Search for:
      <INPUT TYPE="text" NAME="q" SIZE="50" value="abcdefghijklmnopqrstuvwxyz" >
...
<table bgcolor=#EEEEEE width=100% border=0>
  <tr>
    <td>
      <small>Search for <b>abcdefghijklmnopqrstuvwxyz</b>.</small>
      <small>Search results: <b>abcdefghijklmnopqrstuvwxyz: 1 / 1</b>.</small>
    </td>
    <td>
  ...
  <tr><td colspan="2">
      Sort by:
            <b>relevancy</b>&nbsp;|&nbsp;<a href="?np=0&amp;q=abcdefghijklmnopqrstuvwxyz&s=DRP">last modified date</a>
        </td></tr>
</table><DL>
  <DT>1.
