...
SELECT url_id,ref_id, intag, word FROM crossdict ORDER BY url_id,intag;
...
SELECT status, docsize, hops, crc32, last_mod_time, rec_id, url FROM url ORDER BY status, crc32, rec_id;
