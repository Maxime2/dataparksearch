...
static int
dps_sgml_cmp (dps_sgml_char *s1, dps_sgml_char *s2)
{
...
int
DpsSgmlToUni (const char *sgml, dpsunicode_t *wc)
{
  /*     int i;
       int res;*/
...
*/
void
DpsSGMLUniUnescape (dpsunicode_t *ustr)
{
...
int
DpsJSONToUni (const char *json, dpsunicode_t *wc, size_t *icodes)
{
  switch (*json)
    {
    case 'b':
