...
void *
_DpsXmalloc (size_t size, const char *filename, size_t fileline)
{
  void *value;
...
void *
_DpsXrealloc (void *ptr, size_t newsize, const char *filename, size_t fileline)
{
  void *value;
...
void *
DpsXrealloc (void *ptr, size_t newsize)
{
  void *value;
