...
int
dps_wc_mb_gbk (DPS_CONV *conv, DPS_CHARSET *cs, const dpsunicode_t *wc, unsigned char *s, unsigned char *e)
{
  int code;
...
int
dps_mb_wc_gbk (DPS_CONV *conv, DPS_CHARSET *cs, dpsunicode_t *pwc, const unsigned char *s, const unsigned char *end)
{
  int hi;
...
static int
gb18030ext_mbtowc (DPS_CONV *conv, dpsunicode_t *pwc, const unsigned char *s, const unsigned char *e)
{
...
static int
gb18030ext_wctomb (DPS_CONV *conv, dpsunicode_t *wc, unsigned char *s, unsigned char *e)
{
  if (s + 2 > e)
    {
      unsigned short c = 0;
...
static int
gb18030uni_mbtowc (DPS_CONV *conv, dpsunicode_t *pwc, const unsigned char *s)
{
...
static int
gb18030uni_wctomb (DPS_CONV *conv, dpsunicode_t *wc, unsigned char *s, unsigned char *e)
{
  if (s + 4 > e)
    {
      unsigned int i = *wc;
...
int
dps_wc_mb_gb18030 (DPS_CONV *conv, DPS_CHARSET *cs, const dpsunicode_t *wc, unsigned char *s, unsigned char *e)
{
  int code;
...
int
dps_mb_wc_gb18030 (DPS_CONV *conv, DPS_CHARSET *cs, dpsunicode_t *pwc, const unsigned char *s, const unsigned char *end)
{
  int hi, ret;
  const unsigned char *p;
