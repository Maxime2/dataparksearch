...
/*  size_t NFiles = (size_t)DpsVarListFindInt(&Env->Vars, "URLDataFiles", 0x300);*/
  ...
  for (filenum = DPS_MATCH_min; filenum < DPS_MATCH_max; filenum++)
    DpsServerListFree (&Env->Servers[filenum]);
