...
static int
func_sjis_uni_onechar (int code)
{
...
static int
func_uni_sjis_onechar (int code)
{
...
int
dps_wc_mb_sjis (DPS_CONV *conv, DPS_CHARSET *cs, const dpsunicode_t *wc, unsigned char *s, unsigned char *e)
{
  int code;
...
int
dps_mb_wc_sjis (DPS_CONV *conv, DPS_CHARSET *cs, dpsunicode_t *pwc, const unsigned char *s, const unsigned char *end)
{
  int hi = s[0];
