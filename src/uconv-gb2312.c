...
static int
func_gb2312_uni_onechar (int code)
{
...
static int
func_uni_gb2312_onechar (int code)
{
...
int
dps_wc_mb_gb2312 (DPS_CONV *conv, DPS_CHARSET *cs, const dpsunicode_t *wc, unsigned char *s, unsigned char *e)
{
  int code;
...
int
dps_mb_wc_gb2312 (DPS_CONV *conv, DPS_CHARSET *cs, dpsunicode_t *pwc, const unsigned char *s, const unsigned char *end)
{
  int hi;
