...
static int
func_big5_uni_onechar (int code)
{
...
static int
func_uni_big5_onechar (int code)
{
...
int
dps_wc_mb_big5 (DPS_CONV *conv, DPS_CHARSET *cs, const dpsunicode_t *wc, unsigned char *s, unsigned char *e)
{
...
int
dps_mb_wc_big5 (DPS_CONV *conv, DPS_CHARSET *cs, dpsunicode_t *pwc, const unsigned char *s, const unsigned char *end)
{
...
int
dps_mb_wc_cp950 (DPS_CONV *conv, DPS_CHARSET *cs, dpsunicode_t *pwc, const unsigned char *s, const unsigned char *e)
{
...
int
dps_wc_mb_cp950 (DPS_CONV *conv, DPS_CHARSET *cs, const dpsunicode_t *wc, unsigned char *s, unsigned char *e)
{
  unsigned short code;
