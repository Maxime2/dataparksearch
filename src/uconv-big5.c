...
int dps_wc_mb_big5(DPS_CONV *conv, DPS_CHARSET *cs, const dpsunicode_t *wc, unsigned char *s, unsigned char *e) {
...
/**** Microsoft Windows cp950 ****/

/* F9D6 .. F9FE */
static dpsunicode_t tab_cp950_uni[] = {
  0x7881, 0x92B9, 0x88CF, 0x58BB, 0x6052, 0x7CA7, 0x5AFA, 0x2554,  0x2566, 0x2557, 0x2560, 0x256C, 0x2563, 0x255A, 0x2569, 0x255D,
  0x2552, 0x2564, 0x2555, 0x255E, 0x256A, 0x2561, 0x2558, 0x2567,  0x255B, 0x2553, 0x2565, 0x2556, 0x255F, 0x256B, 0x2562, 0x2559,
  0x2568, 0x255C, 0x2551, 0x2550, 0x256D, 0x256E, 0x2570, 0x256F,  0x2593
};	

/* 0x2550 .. 0x2570 */
static unsigned short tab_uni_cp950[] = {
  0xF9F9, 0xF9F8, 0xF9E6, 0xF9EF, 0xF9DD, 0xF9E8, 0xF9F1, 0xF9DF,  0xF9EC, 0xF9F5, 0xF9E3, 0xF9EE, 0xF9F7, 0xF9E5, 0xF9E9, 0xF9F2,
  0xF9E0, 0xF9EB, 0xF9F4, 0xF9E2, 0xF9E7, 0xF9F0, 0xF9DE, 0xF9ED,  0xF9F6, 0xF9E4, 0xF9EA, 0xF9F3, 0xF9E1, 0xF9FA, 0xF9FB, 0xF9FD,
  0xF9FC
};


int dps_mb_wc_cp950(DPS_CONV *conv, DPS_CHARSET *cs, dpsunicode_t *pwc, const unsigned char *s, const unsigned char *e) {

  if ((e - s) > 1) {
    int hi = s[0];
    hi = (hi << 8) + s[1];
    if ((hi >= 0xF9D6) && (hi <= 0xF9FE)) {
      pwc[0] = tab_cp950_uni[hi - 0xF9D6];
      conv->ocodes = 1;
      return conv->icodes = 2;
    }
  }
  return dps_mb_wc_big5(conv, cs, pwc, s, e);
}


int dps_wc_mb_cp950(DPS_CONV *conv, DPS_CHARSET *cs, const dpsunicode_t *wc, unsigned char *s, unsigned char *e) {
  unsigned short code;

  if (*wc >= 0x2550 && *wc <= 0x2570) {
    code = tab_uni_cp950[*wc - 0x2550];
  } else  switch (*wc) {
  case 0x2593: code = 0xF9FE; break;
  case 0x58BB: code = 0xF9D9; break;
  case 0x5AFA: code = 0xF9DC; break;
  case 0x6052: code = 0xF9DA; break;
  case 0x7881: code = 0xF9D6; break;
  case 0x7CA7: code = 0xF9DB; break;
  case 0x88CF: code = 0xF9D8; break;
  case 0x92B9: code = 0xF9D7; break;
  default:
    return dps_wc_mb_big5(conv, cs, wc, s, e);
  }
