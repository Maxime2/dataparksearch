...
int
DpsCrossListAddFantom (DPS_DOCUMENT *Doc, DPS_CROSSWORD *CrossWord)
{
...
int
DpsCrossListAdd (DPS_DOCUMENT *Doc, DPS_CROSSWORD *CrossWord)
{
...
void
DpsCrossListFree (DPS_CROSSLIST *CrossList)
{
  size_t i;
...
DPS_CROSSLIST *
DpsCrossListInit (DPS_CROSSLIST *List)
{
...
int
DpsCrossCmp (const void *p1, const void *p2)
{
...
int
DpsCrossListSort (DPS_CROSSLIST *List)
{
  if (List->ncrosswords > 1)
    DpsSort (List->CrossWord, List->ncrosswords, sizeof (DPS_CROSSWORD), (qsort_cmp) DpsCrossCmp);
}
